...
export default function App() {
  ...
  const [messages, setMessages] = useState<string[]>(['Hi! 👋 How was your day?']);
  ...
  const send = () => {
    ...
    setReply('');
    if (/i go |yesterday.*go|last .* go/i.test(value)) {
      setMessages((m) => [...m, 'Almost! For the past, say “I went”. Where did you go?']);
      setMistake(true);
    } else {
      setMessages((m) => [...m, 'Nice! 👍 Tell me one more detail. What did you enjoy most?']);
    }
  };
